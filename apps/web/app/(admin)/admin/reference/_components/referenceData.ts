    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Tick \"This is a team / corporate booking\" to set up a company class instead: enter the company name and contact, then choose who pays under \"Who is paying?\"",
          "Who is paying? has three options: Each employee (they pay their own way at signup), The company (invoiced one flat total straight away), or Company, per signup (the company is billed a set rate for each person who signs up, invoiced after the class)",
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          { text: "Per-signup team bookings only join that panel once their class has ended, since before that they are meant to be uninvoiced. They show the rate per signup rather than a total, because the total depends on final numbers", role: "manager" },
        ],
      },
      {
        id: "invoice-create",
      ...
      },
      {
        ...
        role: "super",
        bullets: [
          "Upcoming payouts split into three groups: payable now, waiting on payout setup, and in flight at PayPal",
          "Expand any instructor to see which classes the money came from: class name, date, students sold, and the totals for each class",
          "Revenue summary showing what was collected, the SuperHeroCPR cut, real PayPal fees, and what the business actually keeps",
          "Warns when an instructor is missing a PayPal email (their earnings are held, not lost, until they add one)",
          "Send Pending Payouts: submits all eligible pending earnings to PayPal in one batch",
          "Payout history showing every batch, its per-instructor lines, PayPal fees, and retry lineage",
          "Batches PayPal has accepted show as \"assumed complete\" until PayPal confirms delivery: it can still deny a payout at that stage",
          "Sync status: re-checks unconfirmed batches against PayPal (also runs automatically every hour)",
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Payout history table: shows every payout batch you were included in, with amount sent, PayPal fee, status, and any denial or error notes",
          "Payout history always shows the PayPal address the money was actually sent to, even if you've updated your email since",
        ],
      },
    ],
  },
