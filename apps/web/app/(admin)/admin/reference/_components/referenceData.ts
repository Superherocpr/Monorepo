    ...
    sections: [
      {
        ...
        bullets: [
          ...
          "Team / corporate classes show a Team Booking badge and a highlighted panel near the top with the company and contact details, the agreed price, and the signup link to send them, plus a Copy signup link button",
