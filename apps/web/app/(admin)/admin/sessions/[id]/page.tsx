...
export default async function SessionDetailPage({ params }: PageProps) {
  ...
  const session: SessionDetailData = {
    ...
    class_types: raw.class_types as SessionDetailData["class_types"],
    instructor: raw.profiles as SessionDetailData["instructor"],
    locations: raw.locations as SessionDetailData["locations"],
    bookings: (raw.bookings as SessionDetailData["bookings"]) ?? [],
    roster_records:
