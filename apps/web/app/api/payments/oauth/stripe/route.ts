/**
 * GET /api/payments/oauth/stripe
 * Called by: Payment Account page — "Connect Stripe" and "Reconnect" buttons
 * Auth: instructor or super_admin only
 * Builds the Stripe Connect OAuth authorization URL and redirects the
 * instructor to Stripe's consent screen.
...
/**
 * Initiates the Stripe Connect OAuth flow for instructor payment account connection.
...
export async function GET() {
  ...
  cookieStore.set("oauth_state_stripe", state, {
    httpOnly: true,
